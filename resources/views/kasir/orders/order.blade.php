...
@section('content')
    ...
    <div class="flex flex-col gap-6 px-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Cari Nomor Meja</h1>
            </div>
            <div class="flex flex-col sm:flex-row w-full md:w-auto gap-2">
                <form action="{{ route('kasir.orders.index') }}" method="GET">
                    <div class="flex items-center">
                        <input value="{{ request('table_number') }}" type="text" name="table_number" placeholder="Nomor Meja" class="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-600">
        ...
        <!-- Filter transaksi/order berdasarkan tanggal/waktu -->
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
            <!-- <div>
                <h1 class="text-2xl font-bold text-gray-800">Filter Transaksi</h1>
            </div> -->
            <div class="flex flex-col sm:flex-row w-full md:w-auto gap-2">
                <form action="{{ route('kasir.orders.index') }}" method="GET">
                    <div class="flex items-center">
                        ...
                        @forelse($orders as $order)
                            <tr class="even:bg-gray-50 odd:bg-white hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <!-- Print invoice -->
                                    <a href="{{ route('kasir.orders.invoice', ['id' => $order->id]) }}" target="_blank">
